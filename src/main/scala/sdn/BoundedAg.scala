...
abstract class BoundedAgV(init:String, arg: MuStruct[_<:Locus,_ <:Ring] , val follows:Force )
  extends  MovableAg[V](init) with  MovableAgV  with dataStruc.DagNode.Singleton[sdn.MuStruct[_ <: compiler.Locus, _ <: compiler.Ring]]
