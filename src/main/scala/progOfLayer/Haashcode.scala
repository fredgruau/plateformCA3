...
//used to test quick voronoisation protocol, realized through a locus proximity graph precomputed for a small CA
...
/** we artificially create an exression tree of depth 18 si as to check  that hashcode is well cashed, and
 * expression are well memoized.
 * */
