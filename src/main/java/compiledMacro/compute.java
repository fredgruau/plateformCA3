...
// initialisation 
 int auxL82=0,auxL83=0,auxL84=0,auxL85=0,auxL86=0,auxL87=0,auxL88$0=0,auxL88$1=0,auxL88$2=0,auxL88$3=0,auxL88$4=0,auxL88$5=0,r0=0,r1=0,r2=0;
for (int i = 1; i < pneighbor$e.length -1; i++) {
 auxL88$0= pneighbor$e[i] ;auxL88$1= pneighbor$se[i] ;auxL88$2= pneighbor$sw[i] ;auxL88$3= pneighbor$w[i] ;
 auxL88$4= pneighbor$nw[i] ;auxL88$5= pneighbor$ne[i] ;r0= auxL88$2 ;auxL85= r0 ;
 r0= auxL88$1 ;auxL86= r0 ;r0= auxL88$3 ;auxL84= r0 ;
 r0= auxL88$0 ;auxL87= r0 ;r0= auxL88$4 ;auxL83= r0 ;
 r0= auxL88$5 ;auxL82= r0 ;computecountNeighbors$0[i]=((r2=(( auxL87  ^  auxL86 ) ^  auxL85 )) ^ (r1=(( auxL84  ^  auxL83 ) ^  auxL82 )));computecountNeighbors$1[i]=(((r0=( r1  &  r2 )) ^ (r2=(( auxL87  &  auxL86 ) | ( auxL85  & ( auxL87  |  auxL86 ))))) ^ (r1=(( auxL84  &  auxL83 ) | ( auxL82  & ( auxL84  |  auxL83 )))));
 computecountNeighbors$2[i]=(( r0  &  r2 ) | ( r1  & ( r0  |  r2 )));
  }
